...
int bit_vec_filter_no_flipping_sse1(char* read, char* ref, int length, int max_error, int threshold);
int bit_vec_filter_no_flipping_m128_sse1(uint8_t *read_vec0, uint8_t *read_vec1, uint8_t *ref_vec0,
											uint8_t *ref_vec1, __m128i mask, int max_error, int threshold);
int bit_vec_filter_no_flipping_m128_sse1(uint8_t *read_vec0, uint8_t *read_vec1, uint8_t *ref_vec0,
